...
class FccEasClient {
    ...
    async lookup(value) {
        ...
        if (!response.ok) throw Object.assign(new Error('The FCC official lookup is temporarily unavailable. Treat this FCC ID as unverified and check it manually.'), { status: 503, upstreamStatus: response.status });
        let rows;
