...
const { getCanonicalCodes, normalizeCountryCode: normalizeRegistryCountry } = require('./country-registry');

const ALLOWED_COUNTRIES = new Set(getCanonicalCodes());
...
function normalizeCountryStrict(value) {
    return normalizeRegistryCountry(value);
}
