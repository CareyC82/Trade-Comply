...
const INLINE_REGISTRY = {
    version: 1,
    canonical_codes: ['CN', 'US', 'EU', 'DE', 'NL', 'SG', 'MX', 'VN', 'MY', 'ASEAN', 'RU', 'TW', 'JP', 'KR', 'IN', 'AU', 'NZ', 'GLOBAL'],
    route_options: [
    ...
    market_themes: {
        ...
        AU: 'Australia ACMA radio/EMC/telecommunications, RCM responsible-supplier records, EESS electrical safety, product safety and import checks',
        NZ: 'New Zealand RSM radio/EMC, RCM or R-NZ labelling, WorkSafe electrical safety, product safety and import checks',
    ...
    compliance_focus: {
        ...
        AU: {
            export: 'Screen ACMA radio, EMC and telecommunications applicability, RCM and responsible-supplier records, EESS scope, product safety and import evidence.',
            import: 'Check Australia-origin technology, exact-model conformity evidence and any re-export conditions.'
        },
        NZ: {
            export: 'Screen RSM radio/EMC conformity level, RCM or R-NZ marking, licence-to-supply, WorkSafe electrical safety and importer evidence.',
            import: 'Check New Zealand-origin technology, exact-model conformity evidence and any re-export conditions.'
        },
        GLOBAL: {
...
function buildPipelineStructurerSystemPrompt() {
    ...
    const lines = [
        ...
        'country (US|EU|VN|MY|ASEAN|RU|TW|JP|KR|AU|NZ|GLOBAL only), risk_level (High|Medium|Low),',
    ...
    for (const code of ['RU', 'TW', 'VN', 'MY', 'ASEAN', 'US', 'EU', 'JP', 'KR', 'AU', 'NZ']) {
