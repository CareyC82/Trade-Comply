...
function buildSessionChecklist({
    ...
    let fromBaseline = [];
    if (includeBaseline && (!vertical || vertical === 'electronics')) {
        fromBaseline = getCountryBaselineChecklist(country, direction);
    }
    let merged = mergeChecklists(fromBaseline, fromTags, fromAi);
    const segmentApi = typeof globalThis !== 'undefined'
        ? globalThis.TradeComplyChecklistSegment
        : null;
    if (vertical && segmentApi?.filterChecklistForVertical) {
        merged = segmentApi.filterChecklistForVertical(merged, vertical);
    }
    return merged;
}
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = checklistApi;
}

if (typeof globalThis !== 'undefined') {
    globalThis.TradeComplyChecklist = checklistApi;
}
