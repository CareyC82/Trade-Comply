...
const PRODUCT_SIGNALS = [
    ...
    {
        id: 'memory_ic',
        match: /\b(hbm|hbm2e|hbm3e?|dram|ddr[3-6]?|lpddr[3-6]?|gddr[5-7]?|nand|flash\s*memory|memory\s*(chip|ic|module|stack)|storage\s*ic)\b/i,
...
function greenProductTerms(productSignal = {}) {
    const map = {
        ...
        memory_ic: ['hbm', 'dram', 'nand', 'memory chip', 'storage ic', 'semiconductor'],
