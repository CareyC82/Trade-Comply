...
function buildTransitComparison({ card, from, to, productSignal, dutyRates, priorityMatrix, directMarket }) {
    ...
    const secondLegRouteSpecific = Boolean(secondPriorityRoute) || secondDutySignal?.routeSpecific === true;
    const secondLegCoverageLabel = secondLegRouteSpecific
        ? secondCoverage.label
    ...
    const secondLegScopeNote = secondLegRouteSpecific
        ? `${viaLabel} -> ${toLabel} has maintained route-specific or priority-matrix coverage.`
    ...
    return {
        ...
        sourceEvidence: [
            ...
            },
            {
                ...
                detail: `First leg: ${card.coverageLabel}; second leg: ${secondLegCoverageLabel}. ${secondLegScopeNote}`
            },
            {
