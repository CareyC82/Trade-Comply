...
function buildEuOriginEvidenceGate({ origin, destination, via = '', hsCode = '' } = {}) {
    ...
    return {
        ...
        summary: `Regulation (EU) 2026/1455 treatment for US-origin goods entering ${destinationLabel} is available only if ${declaredCode} is listed in the applicable official Annex. Article 59a evidence must also prove direct transport or customs supervision/non-alteration through any third country.`,
        treatments: [
