...
(function exposeCanISellIt(root, factory) {
    ...
    function marketRequirements(market, profile) {
        ...
        if (market === 'US') {
            ...
            if (profile.mainsPowered === true || ['charger', 'power_bank'].includes(profile.productType) || (jpScope?.trigger === 'mains_not_false' && profile.mainsPowered !== false)) {
                const mappedCategory = jpScope?.category ? ` The maintained candidate category is: ${jpScope.category}.` : '';
            ...
            if (profile.mainsPowered === true || profile.productType === 'charger' || (sgScope?.trigger === 'mains_not_false' && profile.mainsPowered !== false)) {
                const mappedCategory = sgScope?.category ? ` The maintained candidate category is: ${sgScope.category}.` : '';
