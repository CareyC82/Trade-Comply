...
(function exposeCanISellIt(root, factory) {
    ...
    function detectProductType(text) {
        const ordered = ['kids_gps_watch', 'smart_ring', 'fitness_tracker', 'earbuds', 'smart_glasses', 'smart_watch'];
    ...
    function buildProcurementDecision({ verdict, documentGaps, economics, unanswered }) {
    ...
    function assess(input) {
        ...
        const procurement = buildProcurementDecision({ verdict, documentGaps, economics, unanswered });
        return {
            verdict,
            verdictLabel,
            profile,
    ...
    return {
        ...
        findDutySignal, estimateEconomics, assess
    };
}));
