...
(function exposeCanISellIt(root, factory) {
    ...
    function assessAnz(input) {
        const australia = assess({ ...input, market: 'AU' });
        const newZealand = assess({ ...input, market: 'NZ' });
        ...
        return {
            ...
            selectedTariff: null,
            economics: null,
            economicsNote: 'Australia and New Zealand have separate tariff, GST and import-value rules. Calculate each destination separately after confirming its exact HS classification.',
            commercialConclusion: {
                code: 'not_calculated',
    ...
    return {
        ...
        findDutySignal, estimateEconomics, assess, assessAnz, buildReviewContact
    };
}));
