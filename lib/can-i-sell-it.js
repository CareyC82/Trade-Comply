...
(function exposeCanISellIt(root, factory) {
    ...
    function detectProductType(text) {
        const ordered = [
            'kids_electronics', 'kids_gps_watch', 'power_bank', 'charger', 'beauty_device',
            ...
            'smart_ring', 'fitness_tracker', 'earbuds', 'smart_glasses', 'smart_watch'
        ];
    ...
    function marketCoverageForProfile(market, profile, supported) {
    ...
    function marketRequirements(market, profile) {
        ...
        if (profile.cameraMic === true) {
            const privacySources = market === 'US' ? ['ftcIot'] : market === 'EU' ? ['edpbVideo'] : [];
    ...
    function assess(input) {
        ...
        const marketCoverage = marketCoverageForProfile(input.market, profile, coverageStatus.supported);
    ...
    return {
        UNKNOWN, detectProductType, detectOutsideCategory, coverageForProfile, marketCoverageForProfile, extractProfile, materialQuestionKeys, getFollowUpQuestions,
