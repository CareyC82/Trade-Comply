...
(function exposeCanISellIt(root, factory) {
    ...
    function buildReviewContact({ description = '', origin = '', market = '', platform = '', productLabel = '', resultLabel = '', reviewService = 'Single Product Review' } = {}) {
    ...
    return {
        ...
        buildDecisionTrace, buildSellerActionPlan, buildComplianceReviewRecommendation,
