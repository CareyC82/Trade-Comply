...
(function (root, factory) {
    ...
    function buildSourceBasis(payload = {}, market = '', industry = '', primaryRows = [], fallbackRows = []) {
        if (market === 'CN') {
    ...
    function buildTradeFlowModel(payload = {}, filters = {}) {
        ...
        const chinaPrimaryRows = market === 'CN'
        ...
        const sourceBasis = buildSourceBasis(payload, market, industry, chinaPrimaryRows, comtradeRows);
        ...
        return {
            ...
            scopeLabel: marketIndustryRows.find((row) => row.scope_label)?.scope_label || industryRow?.label || '',
