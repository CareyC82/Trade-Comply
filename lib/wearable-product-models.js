...
(function exposeWearableModels(root, factory) {
    ...
    const sources = {
        fcc: {
            ...
            monitorUrls: ['https://docs.fcc.gov/public/attachments/FCC-15-92A1.pdf'],
            reviewedAt,
            confidence: 'official',
        ...
        fccExposure: {
            ...
            monitorPolicy: { mode: 'last_good_manual_review', reviewEveryDays: 30 },
            reviewedAt,
        ...
        usElectrical: {
            ...
            monitorUrls: ['https://www.osha.gov/sites/default/files/enforcement/directives/CPL_1-0_3.pdf'],
            monitorPolicy: { mode: 'automatic_with_manual_fallback', reviewEveryDays: 30 },
            reviewedAt,
            confidence: 'official',
        ...
        ftcIot: {
            ...
            monitorUrls: ['https://www.ftc.gov/system/files/documents/plain-language/913a_careful_connections.pdf'],
            monitorRequiredTerms: ['internet of things', 'secure'],
            reviewedAt,
            confidence: 'official_guidance',
        ...
        coppa: {
            ...
            monitorRequiredTerms: ['children', 'privacy protection'],
            reviewedAt,
            confidence: 'official',
        ...
        redCyber: {
            ...
            monitorUrls: ['https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32022R0030'],
            monitorRequiredTerms: ['2022/30'],
            monitorPolicy: { mode: 'automatic_with_manual_fallback', reviewEveryDays: 30 },
            reviewedAt,
            confidence: 'official',
        ...
        euBattery: {
            ...
            reviewedAt: '2026-08-25',
            confidence: 'official',
            lifecycle: { status: 'future', publishedAt: '2023-07-28', effectiveAt: '2027-02-18' },
            scope: 'Battery compliance obligations are phased. Article 11 portable-battery removability and replaceability requirements and the applicable battery-passport phase use 18 February 2027; battery due-diligence obligations were separately postponed to 18 August 2027 and remain turnover- and scope-dependent.'
        },
        gpsr: {
            authority: 'European Commission',
        ...
        gdpr: {
            ...
            monitorUrls: ['https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32016R0679'],
            monitorRequiredTerms: ['2016/679'],
            monitorPolicy: { mode: 'automatic_with_manual_fallback', reviewEveryDays: 30 },
            reviewedAt,
            confidence: 'official',
        ...
        battery: {
            ...
            monitorUrls: ['https://unece.org/transport/dangerous-goods/rev8-files'],
            monitorPolicy: { mode: 'automatic_with_manual_fallback', reviewEveryDays: 30 },
            reviewedAt,
            confidence: 'official',
        ...
        jpRadio: {
            ...
            monitorRequiredTerms: ['conformity', 'technical regulation'],
            monitorPolicy: { mode: 'last_good_manual_review', reviewEveryDays: 30 },
            reviewedAt,
            confidence: 'official',
        ...
        jpPse: {
            ...
            monitorUrls: ['https://www.meti.go.jp/english/policy/economy/consumer/pse/index.html', 'https://www.meti.go.jp/policy/consumer/seian/denan/file/06_guide/denan_guide_ver40_en.pdf'],
            monitorPolicy: { mode: 'automatic_with_manual_fallback', reviewEveryDays: 30 },
            monitorRequiredTerms: ['electrical', 'safety'],
            reviewedAt,
            confidence: 'official',
        ...
        jpOnlineSeller: {
            ...
            monitorUrls: ['https://www.meti.go.jp/english/policy/economy/consumer/product_safety/pse_procedure/index.html'],
            monitorPolicy: { mode: 'automatic_with_manual_fallback', reviewEveryDays: 30 },
            monitorRequiredTerms: ['製品', '安全'],
            reviewedAt,
            confidence: 'official',
        ...
        jpPseProducts: {
            ...
            monitorUrls: ['https://www.meti.go.jp/policy/consumer/seian/denan/file/06_guide/denan_guide_ver40_en.pdf'],
            monitorPolicy: { mode: 'automatic_with_manual_fallback', reviewEveryDays: 30 },
            monitorRequiredTerms: ['電気用品', '341'],
            reviewedAt,
            confidence: 'official',
        ...
        jpProductSafety: {
            ...
            monitorUrls: ['https://www.meti.go.jp/english/policy/economy/consumer/'],
            monitorPolicy: { mode: 'automatic_with_manual_fallback', reviewEveryDays: 30 },
            monitorMigrationHashes: ['f8d9e08e07a21d5c4a06b9688a9df998dd715948f1dc7d1a7cdec7d04db70858'],
            monitorRequiredTerms: ['product safety', 'electrical'],
            reviewedAt,
            confidence: 'official',
        ...
        jpIoTSecurity: {
            ...
            monitorRequiredTerms: ['cyber star', 'security'],
            reviewedAt,
        ...
        jpPrivacy: {
            ...
            monitorUrls: ['https://www.ppc.go.jp/personalinfo/legal/'],
            monitorRequiredTerms: ['personal information', 'act'],
            reviewedAt,
            confidence: 'official',
        ...
        sgImda: {
            ...
            url: 'https://iris.imda.gov.sg/application/general-equipment-registration-%28ger%29',
            monitorUrls: ['https://www.imda.gov.sg/-/media/imda/files/regulations-and-licensing/regulations/frameworks-and-policies/dealer-and-equipment-registration/equipment-registration-framework/eqrguide-june2024.pdf'],
            monitorRequiredTerms: ['equipment registration'],
            reviewedAt,
            confidence: 'official',
        ...
        sgSafety: {
            ...
            url: 'https://www.consumerproductsafety.gov.sg/suppliers/cpsr/overview-of-cpsr/',
            monitorUrls: ['https://www.consumerproductsafety.gov.sg/suppliers/cpsr/resources/'],
            monitorRequiredTerms: ['controlled goods', 'safety mark'],
            reviewedAt,
            confidence: 'official',
        ...
        sgControlledGoods: {
            ...
            monitorUrls: ['https://www.consumerproductsafety.gov.sg/suppliers/cpsr/resources/'],
            monitorRequiredTerms: ['controlled goods', 'safety'],
            reviewedAt,
            confidence: 'official',
        ...
        sgGeneralSafety: {
            ...
            monitorUrls: ['https://www.consumerproductsafety.gov.sg/about/overview/'],
            monitorRequiredTerms: ['consumer goods', 'safety'],
            reviewedAt,
            confidence: 'official',
        ...
        sgIoTSecurity: {
            ...
            monitorRequiredTerms: ['cybersecurity labelling scheme', 'consumer'],
            reviewedAt,
            confidence: 'official_program',
        ...
        sgPrivacy: {
            ...
            monitorUrls: ['https://www.pdpc.gov.sg/-/media/Files/PDPC/PDF-Files/Legislation-and-Guidelines/FINAL-Advisory-Guidelines-on-PDPA-for-Selected-Topics-31-August-2018.pdf'],
            monitorRequiredTerms: ['pdpa'],
            reviewedAt,
            confidence: 'official_guidance',
        ...
        sgChildrenPrivacy: {
            ...
            monitorUrls: ["https://www.pdpc.gov.sg/-/media/files/pdpc/pdf-files/advisory-guidelines/advisory-guidelines-on-the-pdpa-for-children%27s-personal-data-in-the-digital-environment_mar24.pdf"],
            monitorRequiredTerms: ['children', 'personal data'],
            reviewedAt,
            confidence: 'official_guidance',
        ...
        auAcma: {
            ...
            title: 'Check the rules to follow for electrical and electronic products',
            url: 'https://www.acma.gov.au/step-1-check-rules-follow',
            reviewedAt,
            confidence: 'official',
            scope: 'Radio, EMC, telecommunications and electromagnetic-energy rules can overlap; applicability depends on the exact enabled functions.'
        },
        auResponsibleSupplier: {
            authority: 'Australian Communications and Media Authority',
            title: 'Register as a responsible supplier',
            url: 'https://www.acma.gov.au/step-4-register-responsible-supplier',
            reviewedAt,
            confidence: 'official',
            scope: 'A responsible supplier needs the required Australian presence and registration before applying the RCM to covered equipment.'
        },
        auRcm: {
            authority: 'Australian Communications and Media Authority',
            title: 'Label your product',
            url: 'https://www.acma.gov.au/step-5-label-your-product',
            reviewedAt,
            confidence: 'official',
            scope: 'Covered equipment must use the RCM in an allowed physical, electronic, packaging or documentation location and retain compliance records.'
        },
        auEess: {
            authority: 'Electrical Equipment Safety System',
            title: 'Steps for compliance with EESS',
            url: 'https://www.eess.gov.au/equipment/selling-electrical-equipment-in-australia/steps-for-compliance-with-eess/',
            reviewedAt,
            confidence: 'official_linked_baseline',
            scope: 'In-scope household electrical equipment requires responsible-supplier, risk-level, registration and evidence checks; state and territory participation and exact product classification matter.'
        },
        auProductSafety: {
            authority: 'Australian Competition and Consumer Commission — Product Safety',
            title: 'Search mandatory standards',
            url: 'https://www.productsafety.gov.au/business/search-mandatory-standards',
            monitorUrls: ['https://www.productsafety.gov.au/business/understand-product-safety-rules/product-bans-and-how-to-comply'],
            reviewedAt,
            confidence: 'official_linked_baseline',
            scope: 'Mandatory standards, bans and recall signals require a product-specific check in addition to communications and electrical rules.'
        },
        auButtonBattery: {
            authority: 'Australian Competition and Consumer Commission — Product Safety',
            title: 'Button and coin batteries mandatory safety standard',
            url: 'https://www.productsafety.gov.au/business/search-mandatory-standards/button-and-coin-batteries-mandatory-standards/button-and-coin-batteries-mandatory-safety-standard',
            reviewedAt,
            confidence: 'official',
            scope: 'Products containing accessible button or coin batteries require secure compartments, warnings, testing and information controls.'
        },
        auAbfTariff: {
            authority: 'Australian Border Force',
            title: 'Current tariff classification',
            url: 'https://www.abf.gov.au/importing-exporting-and-manufacturing/tariff-classification/current-tariff',
            reviewedAt,
            confidence: 'official_linked_baseline',
            scope: 'Import duty depends on the exact Australian tariff classification, origin and applicable concessions.'
        },
        auAbfGst: {
            authority: 'Australian Border Force',
            title: 'GST and other taxes on imported goods',
            url: 'https://www.abf.gov.au/importing-exporting-and-manufacturing/importing/cost-of-importing-goods/gst-and-other-taxes',
            reviewedAt,
            confidence: 'official_linked_baseline',
            scope: 'Import GST and customs-value components require route and valuation confirmation.'
        },
        nzRsm: {
            authority: 'New Zealand Radio Spectrum Management',
            title: 'Meet the relevant product standards',
            url: 'https://www.rsm.govt.nz/business-individuals/supplier-compliance/steps/step1-meet-standards',
            reviewedAt,
            confidence: 'official',
            scope: 'EMC levels 1–3 and radio levels 1/A1–3/A3 determine the applicable standards and conformity route.'
        },
        nzRsmTesting: {
            authority: 'New Zealand Radio Spectrum Management',
            title: 'Product testing and conformity levels',
            url: 'https://www.rsm.govt.nz/business-individuals/supplier-compliance/steps/step3-product-testing',
            reviewedAt,
            confidence: 'official',
            scope: 'The applicable conformity level determines test evidence, RCM or R-NZ labelling and record-retention requirements.'
        },
        nzSdoc: {
            authority: 'New Zealand Radio Spectrum Management',
            title: "Supplier's Declaration of Conformity",
            url: 'https://www.rsm.govt.nz/business-individuals/supplier-compliance/steps/step-4',
            reviewedAt,
            confidence: 'official',
            scope: 'A signed SDoC and supporting evidence must identify the exact product or supported significant variation.'
        },
        nzRsmSupplier: {
            authority: 'New Zealand Radio Spectrum Management',
            title: 'Supplier registration and licence to supply radio equipment',
            url: 'https://www.rsm.govt.nz/business-individuals/supplier-compliance/steps/step-6',
            reviewedAt,
            confidence: 'official',
            scope: 'Covered suppliers register through ERAC and radio transmitters can require a New Zealand licence to supply.'
        },
        nzRcmRnz: {
            authority: 'New Zealand Radio Spectrum Management',
            title: 'Apply the RCM or R-NZ compliance label',
            url: 'https://www.rsm.govt.nz/business-individuals/supplier-compliance/steps/step-7',
            reviewedAt,
            confidence: 'official',
            scope: 'The applicable conformity level and route determine whether RCM or R-NZ can be used and how the label is displayed.'
        },
        nzElectrical: {
            authority: 'WorkSafe New Zealand',
            title: 'Core requirements for appliances and fittings',
            url: 'https://www.worksafe.govt.nz/topic-and-industry/electricity/appliances-and-fittings/core-requirements/',
            reviewedAt,
            confidence: 'official_linked_baseline',
            scope: 'Electrical appliances and fittings must be electrically safe; supplier declarations, recognised standards and risk classification may apply.'
        },
        nzElectricalRisk: {
            authority: 'WorkSafe New Zealand',
            title: 'High and medium risk products',
            url: 'https://www.worksafe.govt.nz/topic-and-industry/electricity/appliances-and-fittings/high-and-medium-risk-products/',
            reviewedAt,
            confidence: 'official_linked_baseline',
            scope: 'The exact declared article and risk classification determine certification or supplier-declaration obligations.'
        },
        nzProductSafety: {
            authority: 'New Zealand Consumer Protection',
            title: 'Understanding product safety',
            url: 'https://www.consumerprotection.govt.nz/guidance-for-businesses/complying-with-consumer-laws/understanding-product-safety',
            reviewedAt,
            confidence: 'official_linked_baseline',
            scope: 'Suppliers must check applicable product-safety standards, bans, recalls, warnings and reasonable safety expectations.'
        },
        nzCustomsTariff: {
            authority: 'New Zealand Customs Service',
            title: 'Tariff classifications and rates',
            url: 'https://www.customs.govt.nz/business/tariffs/tariff-classifications-and-rates',
            reviewedAt,
            confidence: 'official_linked_baseline',
            scope: 'New Zealand duty depends on exact tariff classification, origin and applicable concessions.'
        },
        nzCustomsGst: {
            authority: 'New Zealand Customs Service',
            title: 'Duty and GST',
            url: 'https://www.customs.govt.nz/sending-and-receiving/duty-and-gst',
            reviewedAt,
            confidence: 'official_linked_baseline',
            scope: 'Import GST and duty require route, value and tariff confirmation.'
        },
        nzMutualRecognition: {
            authority: 'WorkSafe New Zealand',
            title: 'International electrical mutual recognition arrangements',
            url: 'https://www.worksafe.govt.nz/topic-and-industry/electricity/appliances-and-fittings/core-requirements/international-electrical-mras/',
            reviewedAt,
            confidence: 'official_guidance',
            scope: 'Australian evidence is reusable in New Zealand only when the specific recognition conditions, product scope and supplier obligations are satisfied.'
        },
        nzLithiumTransport: {
            authority: 'Civil Aviation Authority of New Zealand',
            title: 'Transporting dangerous goods',
            url: 'https://www.aviation.govt.nz/safety/safety-education-and-advice/transporting-dangerous-goods/',
            reviewedAt,
            confidence: 'official_linked_baseline',
            scope: 'Lithium-battery air transport remains subject to dangerous-goods classification, packaging, documentation and carrier acceptance.'
        }
    };

    const marketScopeMappings = {
        JP: {
            smart_light: { category: 'LED lamp / lighting equipment; exact lamp base, rated voltage and power define the statutory item', trigger: 'mains_not_false', directMains: true, sourceId: 'jpPseProducts' },
            gaming_controller: { category: 'electronic game equipment supplied from AC mains', trigger: 'mains_not_false', directMains: true, sourceId: 'jpPseProducts' },
            mini_projector: { category: 'reflective projector / projection equipment supplied from AC mains', trigger: 'mains_not_false', directMains: true, sourceId: 'jpPseProducts' },
            portable_fan: { category: 'fan or circulator with rated power not exceeding 300 W', trigger: 'mains_not_false', directMains: true, maxPower: 300, sourceId: 'jpPseProducts' },
            electric_shaver: { category: 'electric shaver / grooming motor appliance supplied from AC mains', trigger: 'mains_not_false', directMains: true, sourceId: 'jpPseProducts' },
            video_doorbell: { category: 'intercom / signalling equipment supplied from AC mains', trigger: 'mains_not_false', directMains: true, sourceId: 'jpPseProducts' }
        },
        SG: {
            security_camera: { category: 'mains-fed household audio/video product or bundled AC adaptor rated not more than 250 VAC', trigger: 'mains_not_false', directMains: true, maxVoltage: 250, sourceId: 'sgControlledGoods' },
            smart_light: { category: 'table/standing lamp, lamp control gear or bundled AC adaptor rated not more than 250 VAC', trigger: 'mains_not_false', directMains: true, maxVoltage: 250, sourceId: 'sgControlledGoods' },
            mini_projector: { category: 'mains-fed household audio/video product or bundled AC adaptor rated not more than 250 VAC', trigger: 'mains_not_false', directMains: true, maxVoltage: 250, sourceId: 'sgControlledGoods' },
            portable_fan: { category: 'household ceiling, table, standing or wall fan rated not more than 250 VAC', trigger: 'mains_not_false', directMains: true, maxVoltage: 250, sourceId: 'sgControlledGoods' },
            electric_shaver: { category: 'bundled AC adaptor for shaver rated not more than 250 VAC', trigger: 'mains_not_false', directMains: true, maxVoltage: 250, sourceId: 'sgControlledGoods' },
            video_doorbell: { category: 'mains-fed household audio/video product or bundled AC adaptor rated not more than 250 VAC', trigger: 'mains_not_false', directMains: true, maxVoltage: 250, sourceId: 'sgControlledGoods' },
            baby_monitor: { category: 'mains-fed household audio/video product or bundled AC adaptor rated not more than 250 VAC', trigger: 'mains_not_false', directMains: true, maxVoltage: 250, sourceId: 'sgControlledGoods' }
        },
        AU: {
            charger: { category: 'external power supply / battery charger; determine the EESS declared article and risk level', trigger: 'mains_not_false', directMains: true, sourceId: 'auEess' },
            smart_plug: { category: 'mains-connected switching equipment; determine the EESS declared article and risk level', trigger: 'mains_not_false', directMains: true, sourceId: 'auEess' },
            smart_light: { category: 'mains-connected lighting equipment or control gear; determine EESS scope separately', trigger: 'mains_not_false', directMains: true, sourceId: 'auEess' }
        },
        NZ: {
            charger: { category: 'external power supply / charger; determine the WorkSafe declared-product and risk classification', trigger: 'mains_not_false', directMains: true, sourceId: 'nzElectricalRisk' },
            smart_plug: { category: 'mains-connected switching equipment; determine the WorkSafe risk classification', trigger: 'mains_not_false', directMains: true, sourceId: 'nzElectricalRisk' },
            smart_light: { category: 'mains-connected lighting equipment or control gear; determine the WorkSafe risk classification', trigger: 'mains_not_false', directMains: true, sourceId: 'nzElectricalRisk' }
        }
    };
    ...
    const products = {
        ...
        bluetooth_speaker: {
            ...
            match: /\b(bluetooth|wireless|bt)\s+(portable\s+)?(speakers?|loudspeakers?|sound\s*box(?:es)?)\b|\bportable\s+(bluetooth|bt)\s+(speakers?|loudspeakers?)\b/i,
        ...
        wireless_microphone: {
            ...
            match: /\b(wireless|cordless|bluetooth|2\.4\s*ghz|uhf)\s+(lavalier\s+|lapel\s+|karaoke\s+)?(microphones?|mics?)\b|\b(lavalier|lapel)\s+(wireless\s+)?mics?\b/i,
            candidateHs: ['8518.10'],
        ...
        security_camera: {
            ...
            match: /\b(ip|network|security|surveillance|wi-?fi|wireless|home\s+monitoring)\s+(video\s+)?cameras?\b|\bcctv\s+cameras?\b/i,
            candidateHs: ['8525.89'],
        ...
        wifi_router: {
            label: 'Wi-Fi router',
            match: /\bwi-?fi\s+(routers?|gateways?|access\s+points?)\b|\bwireless\s+(routers?|access\s+points?|gateways?)\b|\bmesh\s+(wi-?fi|routers?|systems?)\b/i,
            candidateHs: ['8517.62'],
        ...
        usb_hub: {
            ...
            match: /\b(usb(?:-c)?|type-?c|thunderbolt)?\s*(hubs?|docking\s+stations?|laptop\s+docks?)\b/i,
        ...
        tablet: {
            ...
            match: /\btablets?(?:\s+(computers?|pcs?|devices?))?\b|\bipad\b|\bandroid\s+tablets?\b/i,
            candidateHs: ['8471.30'],
        ...
        portable_fan: {
            ...
            match: /\b(usb|rechargeable|battery(?:-powered)?|mains|ac)\s+(portable\s+|handheld\s+|desk\s+)?fans?\b|\bportable\s+(usb|rechargeable|mains|ac)\s+fans?\b/i,
            candidateHs: ['8414.51'],
