...
(function exposeWearableModels(root, factory) {
    ...
    const products = {
        ...
        bluetooth_speaker: {
            ...
            match: /\b(bluetooth|wireless)\s+(portable\s+)?speakers?\b|\bportable\s+bluetooth\s+speakers?\b/i,
        ...
        wireless_microphone: {
            ...
            match: /\b(wireless|bluetooth|2\.4\s*ghz|uhf)\s+(lavalier\s+|lapel\s+)?microphones?\b|\bwireless\s+mics?\b/i,
            candidateHs: ['8518.10'],
        ...
        wifi_router: {
            label: 'Wi-Fi router',
            match: /\bwi-?fi\s+(routers?|gateways?|access\s+points?)\b|\bwireless\s+routers?\b|\bmesh\s+wi-?fi\b/i,
            candidateHs: ['8517.62'],
        ...
        smart_plug: {
            label: 'Smart plug',
            match: /\bsmart\s+(plugs?|outlets?|sockets?)\b|\bwi-?fi\s+(plugs?|outlets?|sockets?)\b/i,
        ...
        smart_light: {
            ...
            match: /\bsmart\s+(led\s+)?(lights?|bulbs?|lamps?|light\s*strips?)\b|\b(wi-?fi|bluetooth)\s+(led\s+)?(lights?|bulbs?|lamps?|light\s*strips?)\b/i,
        ...
        wireless_keyboard: {
            ...
            match: /\b(wireless|bluetooth|2\.4\s*ghz)\s+keyboards?\b/i,
            candidateHs: ['8471.60'],
        ...
        gaming_controller: {
            ...
            match: /\b(wireless\s+|bluetooth\s+)?(gaming|game)\s+(controllers?|gamepads?)\b|\bwireless\s+gamepads?\b/i,
        ...
        mini_projector: {
            ...
            match: /\b(mini|portable|pico|smart)\s+projectors?\b/i,
        ...
        electric_shaver: {
            ...
            match: /\b(electric|rechargeable|cordless)\s+(shavers?|razors?|beard\s+trimmers?)\b/i,
            candidateHs: ['8510.10'],
