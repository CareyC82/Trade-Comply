...
(function (root, factory) {
    ...
    function describeRateTrust(rule = {}) {
        ...
        if (merged.includes('exact')) {
            return {
                label: 'Exact HS',
                tone: 'exact',
                detail: 'Best for quote screening when the product matches this maintained HS line.'
            };
        }
    ...
    function buildTariffRow(rule = {}, dutyRates = {}, override = null) {
        ...
        const trust = describeRateTrust(override || rule);
        const row = {
    ...
    function buildWatchItems(syncStatus = {}, limit = 8) {
        ...
        programChanges.forEach((change) => {
            items.push({
                ...
                product: 'Regulation (EU) 2026/1455 / Article 59a',
                ...
                beforeAfter: 'Re-check affected CN lines and filing evidence',
