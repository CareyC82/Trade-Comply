 ...
 * When enabled, requests must present X-Admin-Secret, Bearer, or legacy key headers
...
function buildAdminForbiddenPayload(auth = {}) {
    const messages = {
        ...
        missing_credential: 'Forbidden. Provide X-Admin-Secret or Authorization: Bearer matching a configured admin secret.',
