...
function buildCountryGroupedPolicyIndex(tags) {
    ...
    for (const tag of tags) {
        ...
        grouped[country].push({
            ...
            last_verified_at: tag.last_verified_at || tag.policy_tracker?.last_verified_at || null,
            source_type: tag.source_type || tag.policy_tracker?.source_type || null,
            jurisdiction: tag.jurisdiction || tag.policy_tracker?.jurisdiction || null,
            effective_status: tag.effective_status || tag.policy_tracker?.effective_status || null,
            review_status: tag.review_status || tag.policy_tracker?.review_status || null,
            confidence_score: tag.confidence_score ?? tag.policy_tracker?.confidence_score ?? null
        });
    }
