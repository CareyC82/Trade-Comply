...
function detectProductProfile(description = '', hsCode = '') {
    ...
    if (isGpuChip || isOpticalModule || isDrone || isIndustrialRobot || /\b(semiconductor|gpu|accelerator|optical module)\b/.test(text) || /8542|8486|8479/.test(text)) {
        vertical = 'semiconductor';
    } else if (isSolar || isInverter || isEnergyStorage || isEvCharger || isEScooter || isPowerBank || /solar|photovoltaic|8541|8507\.60|energy storage/.test(text)) {
        vertical = 'new-energy';
    }
...
if (typeof globalThis !== 'undefined') {
    globalThis.TradeComplyIndustryBaseline = api;
}
