...
(function (global) {
    ...
    const FALLBACK_DUTY_RULES = [
        ...
        },
        {
            ...
            sourceStatus: 'official_link_checked',
            sourceNote: 'Singapore official source link monitored; benchmark math refreshed locally. Verify exact HS code, GST value basis, and whether the goods are dutiable before filing.',
        ...
        },
        {
            ...
            confidence: 'Official link monitored',
            sourceStatus: 'official_link_checked',
            sourceNote: 'Mexico official source link monitored; benchmark math refreshed locally. Verify exact TIGIE tariff line, VAT base, NOM scope, and preferential origin before filing.',
        ...
        },
        {
            ...
            confidence: 'Official link monitored',
            sourceStatus: 'official_link_checked',
            sourceNote: 'Japan official source link monitored; benchmark math refreshed locally. Verify exact tariff line, consumption tax basis, and product approval scope before filing.',
        ...
        },
        {
            ...
            confidence: 'Official link monitored',
            sourceStatus: 'official_link_checked',
            sourceNote: 'Korea official source link monitored; benchmark math refreshed locally. Verify exact tariff line, VAT basis, KC scope, and origin preference before filing.',
    ...
    function classifyRateSourceTrust(sourceBreakdown = []) {
        ...
        const taxOnlyEstimate = estimateRows.length > 0
            && estimateRows.every(item => /vat|gst|consumption_tax/i.test(item?.component || ''));
