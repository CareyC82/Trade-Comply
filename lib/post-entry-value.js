    ...
    function buildSpecialProgramDutyAdjustment(valueResult, rule, context = {}, addOnDuty = 0) {
        ...
        if (match.annex === 'II') {
            ...
            return {
                ...
                summary: `Annex II CN ${match.cnCode} suspends the ad valorem component, but the entry-price specific duty remains. The final adjusted duty cannot be completed until that specific component is obtained from TARIC.`
            };
        }
        if (match.annex === 'III') {
            const quotaRate = match.inQuotaAdValoremRate !== null
                ...
                : null;
            const quotaConfirmed = context.quotaAvailable === true;
            ...
            return {
                ...
                summary: `Annex III CN ${match.cnCode} uses quota ${match.orderNumber}. The in-quota rate can be applied only after live quota availability and allocation are confirmed in TARIC.`
            };
        }
        return base;
    }
