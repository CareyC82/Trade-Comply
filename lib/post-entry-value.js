...
(function (global) {
    ...
    function buildOriginEvidenceGate(context = {}) {
        ...
        return {
            ...
            scopeStatus: 'official_annex_confirmation_required',
            annexConfirmationRequired: true,
            summary: `Regulation (EU) 2026/1455 treatment is available only if ${hsCode} is listed in the applicable official Annex. Article 59a also requires direct-transport or customs-supervision/non-alteration evidence for US-origin goods.`,
            treatments: [
