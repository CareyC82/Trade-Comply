...
(function (global) {
    ...
    const FALLBACK_DUTY_RULES = [
        ...
        },
        {
            importCountry: 'US',
            originCountry: 'CN',
            hsPrefixes: ['8517', '8525', '8528', '8543'],
            label: 'US import electronics signal',
            baseRate: 0.019,
            additionalRate: 0.075,
            addOnLayers: [
                {
            ...
            confidence: 'Indicative',
            sourceStatus: 'official_source_checked',
            sourceNote: 'Pre-check benchmark for common electronics categories; verify exact HTS line.',
        ...
        },
        {
            ...
            confidence: 'Indicative',
            sourceStatus: 'indicative',
            sourceNote: 'EU import benchmark only. VAT varies by member state and exact tariff code.',
            sourceHts: '850440',
            sourceRateText: 'Benchmark: duty 2.7% + VAT placeholder',
        ...
        },
        {
            ...
            label: 'Germany import electronics / new energy signal',
            baseRate: 0.027,
            additionalRate: 0.19,
            addOnLayers: [
                {
            ...
            confidence: 'Indicative',
            sourceStatus: 'indicative',
            sourceNote: 'Germany benchmark uses EU customs framework and local VAT. Confirm exact TARIC line.',
            sourceHts: 'EU electronics benchmark',
        ...
        },
        {
            ...
            originCountry: '*',
            hsPrefixes: ['847130', '850440', '850760', '8517', '8528', '8541', '8542'],
            label: 'Netherlands import electronics / new energy signal',
            baseRate: 0.027,
            additionalRate: 0.21,
            addOnLayers: [
                {
            ...
            confidence: 'Indicative',
            sourceStatus: 'indicative',
            sourceNote: 'Netherlands benchmark uses EU customs framework and local VAT. Confirm exact TARIC line.',
            sourceHts: 'EU electronics benchmark',
        ...
        },
        {
            ...
            confidence: 'Indicative',
            sourceStatus: 'indicative',
            sourceNote: 'Singapore benchmark for common electronics imports. Confirm GST and dutiable-goods treatment.',
        ...
        },
        {
            ...
            confidence: 'Indicative',
            sourceStatus: 'indicative',
            sourceNote: 'Mexico benchmark only. Confirm TIGIE duty, VAT, NOM, and origin preference before filing.',
        ...
        },
        {
            ...
            confidence: 'Indicative',
            sourceStatus: 'indicative',
            sourceNote: 'Japan benchmark only. Confirm exact tariff and consumption tax treatment.',
        ...
        },
        {
            ...
            confidence: 'Indicative',
            sourceStatus: 'indicative',
            sourceNote: 'Korea benchmark only. Confirm exact tariff and VAT treatment.',
    ...
    function buildDutySourceBreakdown(rule, addOnLayers = []) {
        ...
        const rows = [{
            label: 'Base duty',
            status: normalizeSourceStatus(rule.sourceStatus, Boolean(rule.sourceUrl) && rule.sourceStatus !== 'indicative'),
            source: baseSource,
            detail: baseDetail,
            url: rule.sourceUrl || '',
